...
import {DTypes, FacetCut, Initializer} from "./Types.sol";
import {DSCore} from "./Logic.sol";
import {ds} from "./State.sol";

contract Diamond is DTypes {
    ...
    fallback() external payable {
        ...
        if (facet == address(0)) revert DIAMOND_FUNCTION_DOES_NOT_EXIST(msg.sig);
