...
import 'mocha'
import type { ONE, ERC20Mock } from './typechain'
import type { PythViewStruct } from './typechain/src/contracts/interfaces/KopioCore'
...
declare module 'hardhat/types/runtime' {
  interface HardhatRuntimeEnvironment {
    ...
    /* ------------------------------- Convenience ------------------------------ */
    Diamond: TC['KopioCore']
    facets: { name: string; address: string; functions: number }[]
    DeploymentFactory: TC['ProxyFactory']
    ONE: TestAsset<ONE, any>
    kopios: TestAsset<Kopio, 'mock'>[]
    extAssets: TestAsset<ERC20Mock, 'mock'>[]
    updateData: () => Hex[]
...
declare module 'mocha' {
  export interface Context {
    kopios: TestAsset<Kopio, 'mock'>[]
    collaterals: TestAsset<ERC20Mock>[]
  }
}
